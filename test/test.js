...
describe('#fizzBuzz()', function () {
  it('calculates fizzBuzz', function () {
    assert.equal(fns.fizzBuzz(3), "1, 2, fizz")
    assert.equal(fns.fizzBuzz(5), "1, 2, fizz, 4, buzz")
    assert.equal(fns.fizzBuzz(15), "1, 2, fizz, 4, buzz, fizz, 7, 8, fizz, buzz, 11, fizz, 13, 14, fizzBuzz")
  });
});
